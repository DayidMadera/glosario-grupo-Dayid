...
Sistema Operativo (SO): Gestiona el hardware y servicios (Windows, Linux, Android).

## 'Controladores de Dispositivo (Drivers)': Conectan el sistema operativo con el hardware.
BIOS/Firmware: Programa inicial de arranque.
